...
namespace Staff_Purchase_.Forms
{
    public partial class Staff_Purchase : System.Web.UI.Page
    {
        ...
        private void LoadSupData()
        {
            ...
            string query = "SELECT Branch_Code AS [Code],Loc_Name AS [Name],Loc_Type AS [Type] FROM [StaffPurchase].[dbo].[T_Mas_Location] WHERE Status IN('A','P') and Loc_Group = 'RT' ";
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                string sqlQueryLinkBranchCustomer = "INSERT INTO [StaffPurchase].[dbo].[T_Link_BranchCustomer] (Branch_Code, Customer_Id, Fixed) " +
